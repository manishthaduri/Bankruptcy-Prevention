...
if selected_option=="💾 About":
    ...
    st.markdown(
        ...
        This app provides **Bank Ruptcy predication** based on bankruptcy data using **Support Vector Regressor**.

        ### Model Description:
        - A Support Vector Regressor is utilized to build the model.
        - A XGBoost model is used incorporates feature importance of the columns.
        - The KNN model is performed well and given the more accuracy.
    ...
    options = ['Select Options', 'data', 'Visualization', 'Feature importance']
    #dropdown box
